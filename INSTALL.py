...
try:
    ...
    _quit("Could not remove old installation.", e)
...
try:
    ...
    _quit("Could not copy files to installation directory.", e)
...
try:
    ...
    _quit("Could not create symbolic link to application script.", e)
...
if CONFIG_FILES:
    try:
        ...
        _quit("Could not copy configuration files.", e)
